...
export function Cadastrar_professor({open, setOpen}) {
  ...
  return (
    <>
      ...
      <Dialog open={open} handler={handleOpen} size="xxl" className="w-full max-w-[1000px] bg-transparent shadow-none flex justify-center items-center">
        {/* ALINHAR CENTRO-Y */}
        <Card className="w-full max-w-[1000px] p-10">
          ...
          <CardFooter className="pt-0">
            <Button variant="gradient"  fullWidth className='botao_cad mt-10'>
              Cadastrar
            </Button>
          </CardFooter>
